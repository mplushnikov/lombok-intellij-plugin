...
public class LombokElementFinder extends PsiElementFinder {
  ...
  public PsiClass findClass(@NotNull String qualifiedName, @NotNull GlobalSearchScope scope) {
    ...
    if (null != parentClass) {
      if (PsiAnnotationSearchUtil.isAnnotatedWith(parentClass, Builder.class, lombok.Builder.class)) {
        ...
        for (PsiMethod psiMethod : psiMethods) {
          if (PsiAnnotationSearchUtil.isAnnotatedWith(psiMethod, Builder.class, lombok.Builder.class)) {
            return parentClass.findInnerClassByName(shortName, false);
          }
        }
      }
