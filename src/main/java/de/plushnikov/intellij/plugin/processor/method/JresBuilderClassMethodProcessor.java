 ...
 */
public class JresBuilderClassMethodProcessor extends AbstractMethodProcessor {

  private final JresBuilderHandler builderHandler;

  public JresBuilderClassMethodProcessor(@NotNull JresBuilderHandler builderHandler) {
