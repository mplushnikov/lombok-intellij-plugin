 ...
 */
public class JresBuilderPreDefinedInnerClassFieldProcessor extends AbstractJresBuilderPreDefinedInnerClassProcessor {

  public JresBuilderPreDefinedInnerClassFieldProcessor(@NotNull JresBuilderHandler builderHandler) {
