...
public class JresWitherProcessor extends AbstractClassProcessor {
  private static final String BUILDER_DEFAULT_ANNOTATION = Builder.Default.class.getCanonicalName();

  private final JresWitherFieldProcessor fieldProcessor;

  public JresWitherProcessor(@NotNull JresWitherFieldProcessor witherFieldProcessor) {
