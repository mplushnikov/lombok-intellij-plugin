 ...
 */
public class JresSuperBuilderClassProcessor extends AbstractClassProcessor {

  private final JresSuperBuilderHandler builderHandler;

  public JresSuperBuilderClassProcessor(@NotNull JresSuperBuilderHandler superBuilderHandler) {
