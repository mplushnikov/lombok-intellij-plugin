 ...
 */
public class JresSuperBuilderProcessor extends AbstractClassProcessor {

  private final JresSuperBuilderHandler builderHandler;

  public JresSuperBuilderProcessor(@NotNull JresSuperBuilderHandler superBuilderHandler) {
