...
public class JresWitherFieldProcessor extends AbstractFieldProcessor {

  private final RequiredArgsConstructorProcessor requiredArgsConstructorProcessor;

  public JresWitherFieldProcessor(@NotNull RequiredArgsConstructorProcessor requiredArgsConstructorProcessor) {
  ...
  public boolean validConstructor(@NotNull PsiClass psiClass, @NotNull ProblemBuilder builder) {
    ...
    if (PsiAnnotationSearchUtil.isAnnotatedWith(psiClass, RequiredArgsConstructor.class, JRESData.class)) {
