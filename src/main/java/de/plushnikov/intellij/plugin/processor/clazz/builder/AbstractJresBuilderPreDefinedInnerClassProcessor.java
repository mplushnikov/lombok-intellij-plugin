...
public abstract class AbstractJresBuilderPreDefinedInnerClassProcessor extends AbstractClassProcessor {

  final JresBuilderHandler builderHandler;

  AbstractJresBuilderPreDefinedInnerClassProcessor(@NotNull JresBuilderHandler builderHandler,
