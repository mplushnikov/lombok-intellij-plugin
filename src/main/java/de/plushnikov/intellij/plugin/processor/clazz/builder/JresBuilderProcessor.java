...
import de.plushnikov.intellij.plugin.processor.handler.JresBuilderHandler;
 ...
 */
public class JresBuilderProcessor extends AbstractClassProcessor {
  ...
  private final JresBuilderHandler builderHandler;
  private final AllArgsConstructorProcessor allArgsConstructorProcessor;

  public JresBuilderProcessor(@NotNull JresBuilderHandler builderHandler, @NotNull AllArgsConstructorProcessor allArgsConstructorProcessor) {
