...
public class JresSuperBuilderHandler extends JresBuilderHandler {
  ...
  public JresSuperBuilderHandler(@NotNull JresToStringProcessor toStringProcessor, @NotNull NoArgsConstructorProcessor noArgsConstructorProcessor) {
  ...
  private Collection<PsiMethod> addAllMethodsForBaseBuilderClass(@NotNull PsiClass psiClass, @NotNull PsiAnnotation psiAnnotation,
    ...
    if (!existedMethodNames.contains(JresToStringProcessor.METHOD_NAME)) {
