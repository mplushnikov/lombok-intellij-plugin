...
import de.plushnikov.intellij.plugin.processor.handler.JresSuperBuilderHandler;
...
public abstract class AbstractJresSuperBuilderPreDefinedInnerClassProcessor extends AbstractClassProcessor {

  final JresSuperBuilderHandler builderHandler;

  AbstractJresSuperBuilderPreDefinedInnerClassProcessor(@NotNull JresSuperBuilderHandler builderHandler,
